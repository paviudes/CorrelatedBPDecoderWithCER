    ...
    for qubit in range(1, n_qubits + 1):
        ...
        for neighbor in neighbors[qubit]:
            ...
            if undirected_key not in undirected_pair_q:
                q_val = np.random.normal(loc=q_mean, scale=0.2)# Sample q_val from a normal distribution around q_mean with std-dev=scale
...
output_dir_errors = "BB_codes/72q_BB_p_0.008_q_0.2_std_0.2_data/testing_data"
output_dir_CER = "BB_codes/72q_BB_p_0.008_q_0.2_std_0.2_data/correlated_weights"
output_dir_prob = "BB_codes/72q_BB_p_0.008_q_0.2_std_0.2_data/assigned_probabilities"
...
training_dir = "BB_codes/72q_BB_p_0.008_q_0.2_std_0.2_data/training_data"
os.makedirs(training_dir, exist_ok=True)
for p_value in p_values:
    for q_mean in q_means:
        for s in range(1, n_samples + 1):

            filename = f"BB_codes/72q_BB_p_0.008_q_0.2_std_0.2_data/testing_data/test_ballistic_p_{p_value}_q_{q_mean}_s_{s}.txt"
