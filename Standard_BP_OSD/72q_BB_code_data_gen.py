...
output_dir_errors = "Standard_BP_OSD/72q_BB_p_0.006_q_0.1_std_0.1_data/testing_data"
output_dir_CER = "Standard_BP_OSD/72q_BB_p_0.006_q_0.1_std_0.1_data/correlated_weights"
output_dir_prob = "Standard_BP_OSD/72q_BB_p_0.006_q_0.1_std_0.1_data/assigned_probabilities"
...
training_dir = "Standard_BP_OSD/72q_BB_p_0.006_q_0.1_std_0.1_data/training_data"
os.makedirs(training_dir, exist_ok=True)
for p_value in p_values:
    for q_mean in q_means:
        for s in range(1, n_samples + 1):

            filename = f"Standard_BP_OSD/72q_BB_p_0.006_q_0.1_std_0.1_data/testing_data/test_ballistic_p_{p_value}_q_{q_mean}_s_{s}.txt"
