...
function train_neuralbp(
    ...
    bpnn = NeuralBP(
        ...
        initial_llrs,
        n_hidden_layers;
        weights_v2c_c2v=ones(Float32, nb_neurons_per_layer, nb_neurons_per_layer, n_hidden_layers),
        weights_c2v_v2c=ones(Float32, nb_neurons_per_layer, nb_neurons_per_layer, n_hidden_layers),
