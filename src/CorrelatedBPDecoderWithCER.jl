...
using LinearAlgebra, JSON, Random, DelimitedFiles
...
export ErrorModel, IIDErrorModel, sample_error, print_error_model_info, separate_error_components, join_error_components, BallisticErrorModel, ExplicitErrorModel, sample_errors

include("postprocessing.jl")
export DecoderStatistics, print_decoder_statistics, save_decoder_statistics, get_output_filename
...
include("bp_algo.jl")
export BPSettings, print_bp_settings, belief_propagation_decoder, save_bp_settings, load_bp_settings, is_decoder_failure
